"""
Automated Pytest for mitotic-count-density-standardizer Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    MitoticcountdensitystandardizerEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = MitoticcountdensitystandardizerEnrichmentSuite()
